...
1. Добавь бота администратором в Telegram-группу и выполни `/setup` от имени
   администратора группы.
2. Открой личный чат с ботом и нажми `/start`.
3. Нажми «Добавить участников» и выбери до 10 пользователей. Бот добавит только
   тех, чьё членство в основной группе подтвердит Telegram.
4. Открой Mini App кнопкой «Открыть панель» и создай напоминание.
5. Новые участники и пользователи, активные в группе, добавляются автоматически.
