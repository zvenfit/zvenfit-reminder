...
3. Открой Mini App кнопкой «Открыть панель».
4. В разделе «Участники» опубликуй кнопку подключения в нужной группе.
   Каждый человек нажимает её сам; бот проверяет членство именно в этой группе.
5. Создай первое напоминание.
6. Если доступно несколько групп, выбери нужную в верхней части Mini App. Новые
...
- `/members` — владельцу или организатору опубликовать кнопку подключения участников
