...
2. Открой Mini App и нажми «Участники», затем выбери до 10 пользователей.
   Запасной сценарий для старых клиентов: в личном чате с ботом выполни
   `/start` и нажми «Добавить участников». При нескольких workspace кнопка подписана именем
